...
public class ScannerTest {
	...
	{
		this.dfa = DFA_LALA;
		yields("LaaaaaaaaLaaaaa     Laaaaa         Li", "LaaaaaaaaLaaaaa     Laaaaa         Li");
		yields("Laaaa Laaaaaaaa Laaaaa Laaaa Laaaaa Li La", "Laaaa Laaaaaaaa ", "Laaaaa Laaaa Laaaaa Li ", "La");
	}
